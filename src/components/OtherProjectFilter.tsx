  ...
  return (
    ...
    >
      ...
      <div className="mb-4">
        ...
        <select
          className="w-full border border-gray-300 bg-white dark:bg-gray-800 dark:border-gray-600 text-gray-900 dark:text-gray-200 rounded px-3 py-2 focus:outline-none focus:ring-2 transition-all"
