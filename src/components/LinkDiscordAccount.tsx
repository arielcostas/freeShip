...
export default function LinkDiscordAccount() {
  ...
  const checkDiscordLink = async () => {
    try {
      ...
      console.error("Error al verificar la vinculación de Discord:", error);
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleUnlinkDiscord = async () => {
    try {
      ...
      console.error("Error al desvincular la cuenta de Discord:", error);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="p-4 border rounded-md bg-white">
      <h3 className="text-lg font-medium mb-2">Cuenta de Discord</h3>

      {isLinked ? (
        <div>
          <p className="mb-2">
            Tu cuenta está vinculada con Discord: <strong>{discordUsername}</strong>
          </p>
          <Button
        ...
        <div>
          <p className="mb-2">
            Vincula tu cuenta de Discord para unirte automáticamente a los canales de proyectos.
          </p>
          <Button
